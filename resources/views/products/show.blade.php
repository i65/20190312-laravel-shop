            ...
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-7">
                            ...
                            <div class="sales_and_reviews">
                                ...
                                <div class="review_count">累计评分 <span class="count">{{ $product->review_count }}</span></div>
                                <div class="rating">评分 <span class="count">{{ str_repeat('★', floor($product->rating)) }}{{ str_repeat('☆', floor(5 - $product->rating)) }}</span></div>
                            </div>
                            <div class="skus">
                                <label for="">选择</label>
                ...
                <div class="product-detail">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a href="#product-detail-tab" aria-controls="product-detail-tab" class="nav-link active" role="tab" data-toggle="tab" aria-selected="true">商品详情</a>
                        </li>
                        <li class="nav-item">
